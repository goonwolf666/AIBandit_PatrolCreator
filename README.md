...
A PowerShell script that generates randomized dynamic patrol groups for DayZ's AI Bandit (AIB) system. This tool reads waypoint data from DayZ Editor JSON files and loot/NPC item pools to create diverse, procedurally-generated patrol configurations suitable for insertion into `DynamicAIB.json`.
